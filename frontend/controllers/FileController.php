...
class FileController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['logout','index','create','view','delete','update','unlink'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
        ...
        $model = new Fileimg();
         ...
         if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            try{
               ...
               if($model->save()){
                   $picture->saveAs('C:/xampp/htdocs/advanced/frontend/img/fileimg/' . $model->name.'.'.$picture->extension);
    ...
    public function actionDelete($id)
    {
        ...
        unlink('C:/xampp/htdocs/advanced/frontend/img/fileimg/'. $model->img);
